  ...
  return (
    <section className="grid grid-cols-1 gap-6 p-4 md:grid-cols-2 lg:grid-cols-3 lg:p-6">
      <div className="relative overflow-hidden transition-transform duration-300 ease-in-out rounded-lg shadow-lg group hover:shadow-xl hover:-translate-y-2">
        ...
        <div className="p-4 bg-background">
          ...
          <p className="text-sm text-muted-foreground">
            One of the most iconic and beautiful monuments in the world, the Taj Mahal is a testament to India&#39;s rich architectural heritage.
          </p>
        </div>
      </div>
      <div className="relative overflow-hidden transition-transform duration-300 ease-in-out rounded-lg shadow-lg group hover:shadow-xl hover:-translate-y-2">
        ...
        <Image
          src="https://c02.purpledshub.com/uploads/sites/41/2023/08/Himalayas-Getty-e1691664200559-1024x684.jpg?w=1200"
        ...
        <div className="p-4 bg-background">
          ...
          <p className="text-sm text-muted-foreground">
            The majestic Himalayan mountain range, home to some of the highest peaks in the world, offers breathtaking natural beauty and adventure.
          </p>
        </div>
      </div>
      <div className="relative overflow-hidden transition-transform duration-300 ease-in-out rounded-lg shadow-lg group hover:shadow-xl hover:-translate-y-2">
        ...
        <Image
          src="https://media.licdn.com/dms/image/D5612AQH7d1aTU312Iw/article-cover_image-shrink_720_1280/0/1692785210884?e=2147483647&v=beta&t=EGaO43slYXborFey21Gp2zGi_LgZCGeEIQNuPc75P1E"
          alt="Holi Festival"
          className="object-cover w-full h-64"
        />
        <div className="p-4 bg-background">
      ...
      <div className="relative overflow-hidden transition-transform duration-300 ease-in-out rounded-lg shadow-lg group hover:shadow-xl hover:-translate-y-2">
        ...
        <Image
          src="https://www.rajasthantourplanner.com/blog/wp-content/uploads/2021/04/Famous-Textiles-of-Rajasthan.jpg"
          alt="Rajasthani Textiles"
          className="object-cover w-full h-64"
        />
        <div className="p-4 bg-background">
          <h3 className="text-xl font-bold">Rajasthani Textiles</h3>
          <p className="text-sm text-muted-foreground">
            The vibrant and intricate textiles of Rajasthan, including block printing, embroidery, and tie-dye, are a testament to India&#39;s rich textile heritage.
          </p>
        </div>
      </div>
      <div className="relative overflow-hidden transition-transform duration-300 ease-in-out rounded-lg shadow-lg group hover:shadow-xl hover:-translate-y-2">
        ...
        <Image
          src="https://images.travelandleisureasia.com/wp-content/uploads/sites/2/2022/02/18114941/Nalanda-University.jpg"
      ...
      <div className="relative overflow-hidden transition-transform duration-300 ease-in-out rounded-lg shadow-lg group hover:shadow-xl hover:-translate-y-2">
        ...
        <Image
          src="https://Image.freepik.com/free-vector/set-yoga-postures_1308-119286.jpg"
          alt="Yoga"
          className="object-cover w-full h-64"
        />
        <div className="p-4 bg-background">
          ...
          <p className="text-sm text-muted-foreground">
            Originating in India, the ancient practice of yoga offers a holistic approach to physical, mental, and spiritual well-being.
          </p>
        </div>
      </div>
      ...
      <div className="relative overflow-hidden transition-transform duration-300 ease-in-out rounded-lg shadow-lg group hover:shadow-xl hover:-translate-y-2">
        <Link
          href="https://en.wikipedia.org/wiki/Information_technology_in_India#:~:text=The%20information%20technology%20(I.T.)%20industry,245%20billion%20in%20FY%202023."
        ...
        <Image
          src="https://st.adda247.com/https://adda247jobs-wp-assets-prod.adda247.com/articles/wp-content/uploads/2023/11/04122906/Information-Technology-Development-in-India.jpg"
          alt="it"
          className="object-cover w-full h-64"
        />
        <div className="p-4 bg-background">
      ...
      <Link href="/about" className="text-gray-700 hover:text-blue-500 text-center font-bold">
        For more info about them click me
      </Link>
    </section>
  );
}
